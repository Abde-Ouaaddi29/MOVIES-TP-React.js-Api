...
import { SETPAGES, SETSEARCH } from "../REDUX/actions";
      ...
      <nav className="bg-purple-300 flex  justify-center items-center shadow-md">
        <div className="w-10/12  flex p-4 justify-between items-center">
          ...
          <div className=" lg:w-4/12 w-8/12 flex justify-center">
            <input
              ref={searchRef}
              className="w-8/12 rounded px-3 outline-purple-300"
              placeholder="search..."
              type="text"
              name="search"
              id="search"
            ...
            <button
              ...
              className=" hover:bg-purple-400  lg:px-4 px-2 py-1 ml-1 rounded bg-purple-200 font-light tracking-tight hover:transition-all"
            >
              search
            </button>
          </div>
